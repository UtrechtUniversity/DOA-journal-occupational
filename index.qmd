...
7.  **Dataset**: Description of a dataset with the potential to be reused by other practitioners and researchers in the occupational health field. The referred dataset should be deposited in a public repository (i.e., Harvard Dataverse, Figshare).
...
10. **Commentaries**: Opinion pieces, perspectives, debates, journal clubs on current issues in occupational health.
